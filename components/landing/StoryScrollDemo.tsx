  ...
  return (
    <FlowArt aria-label="WnCC Presentation">
      <FlowSection aria-label="Who we are" style={{ backgroundColor: '#D4643B', color: '#fff' }}>
        <p className="text-sm sm:text-xs font-bold uppercase tracking-[0.2em]">01 — Who we are</p>
        <hr className="my-6 sm:my-[2vw] border-none border-t border-black opacity-100" />
        <div>
          <h1 className="text-[4.2rem] sm:text-[clamp(3.5rem,12vw,14rem)] font-bold leading-[0.85] uppercase tracking-tight">
            Code
            <br />
            Without
            <br />
        ...
        <hr className="my-6 sm:my-[2vw] border-none border-t border-black opacity-100" />
        <p className="mt-auto max-w-[50ch] text-[1.25rem] sm:text-[clamp(1rem,2.5vw,2rem)] font-normal leading-relaxed">
      ...
      <FlowSection aria-label="The mission" style={{ backgroundColor: '#050505', color: '#fff' }}>
        <p className="text-sm sm:text-xs font-bold uppercase tracking-[0.2em]">02 — The mission</p>
        <hr className="my-6 sm:my-[2vw] border-none border-t border-white/60" />
        <div>
          <h2 className="text-[4.2rem] sm:text-[clamp(3.5rem,12vw,14rem)] font-bold leading-[0.85] uppercase tracking-tight">
            Learn
            <br />
            Build
            <br />
      ...
      <FlowSection aria-label="What we do" style={{ backgroundColor: '#D9A84E', color: '#000' }}>
        <p className="text-sm sm:text-xs font-bold uppercase tracking-[0.2em]">03 — What we do</p>
        <hr className="my-6 sm:my-[2vw] border-none border-t border-black/60" />
        <div>
          <h2 className="text-[4.2rem] sm:text-[clamp(3.5rem,12vw,14rem)] font-bold leading-[0.85] uppercase tracking-tight">
            Code.
            <br />
      ...
      <FlowSection aria-label="Why Join Us" style={{ backgroundColor: '#00D4FF', color: '#000' }}>
        <p className="text-sm sm:text-xs font-bold uppercase tracking-[0.2em]">04 — Why Join Us</p>
        <hr className="my-6 sm:my-[2vw] border-none border-t border-black/50" />
        <div>
          <h2 className="text-[4.2rem] sm:text-[clamp(3.5rem,12vw,14rem)] font-bold leading-[0.85] uppercase tracking-tight">
            Future
            <br />
      ...
      <FlowSection aria-label="Join us" style={{ backgroundColor: '#111214', color: '#fff' }}>
        <p className="text-sm sm:text-xs font-bold uppercase tracking-[0.2em]">05 — Join us</p>
        <hr className="my-6 sm:my-[2vw] border-none border-t border-white/60" />
        <div>
          <h2 className="text-[4.2rem] sm:text-[clamp(3.5rem,12vw,14rem)] font-bold leading-[0.85] uppercase tracking-tight text-white">
            Ready
            <br />
            To
            <br />
